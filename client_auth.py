...
users_email_address = "<email here>"
users_password      = "<password here>"

target_authenticated_google_app_engine_uri = 'http://simplerepo.appspot.com/collection/form'
my_app_name = "simplerepo"
...
full_serv_uri = "http://simplerepo.appspot.com/_ah/login?%s" % (urllib.urlencode(serv_args))
